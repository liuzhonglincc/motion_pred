...
下载DanceTrack数据集，放置在motion_pred/dancetrack 目录下，annotations/val/val_seqmap.txt 是必须的
...
python3 tools/track_iou_pred_model.py datasets/MOT17 --default-parameters --benchmark "MOT17" --eval "val" --fp16 --fuse --seed 153 --track_high_thresh 0.7
kf + stram
python3 tools/track_iou_stram.py datasets/MOT17 --default-parameters --benchmark "MOT17" --eval "val" --fp16 --fuse --track_high_thresh 0.7
组约束 + stram
python3 tools/track_iou_pred_model_stram.py datasets/MOT17 --default-parameters --benchmark "MOT17" --eval "val" --fp16 --fuse --seed 153
```