...
import random
import os
from group_constrained.utils import calculate_ciou, convert_boxes
from collections import deque

def get_args_parser():
    parser = argparse.ArgumentParser('motion pred', add_help=False)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('motion pred', parents=[get_args_parser()])
