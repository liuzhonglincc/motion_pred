...
import sys
sys.path.append('/media/disk1/yjt/lzl/motion_pred')

from ByteTrack.yolox.core import launch
from ByteTrack.yolox.exp import get_exp
from ByteTrack.yolox.utils import configure_nccl, fuse_model, get_local_rank, get_model_info, setup_logger
...
def make_parser():
    ...
    # tracking args
    parser.add_argument("--track_thresh", type=float, default=0.71, help="tracking confidence threshold")
...
def main(exp, args, num_gpu):
    ...
    # start evaluate
    *_, summary = evaluator.evaluate_our_pred_model(
