...
def image_track(predictor, vis_folder, args):
    ...
    for frame_id, img_path in enumerate(files, 1):
        ...
        if outputs[0] is not None:
            ...
            trackerTimer.tic()
            online_targets = tracker.update_iou_no_motion_SORT(detections)
            trackerTimer.toc()
...
def main(exp, args):
    ...
    return image_track(predictor, "/media/disk1/yjt/lzl/motion_pred/mot_metrix/pred_no_motion", args)
...
if __name__ == "__main__":
    ...
    for seq_num in seqs:
        accs.append(eval_seq(seq_num, "/media/disk1/yjt/lzl/motion_pred/mot_metrix/gt", "/media/disk1/yjt/lzl/motion_pred/mot_metrix/pred_no_motion"))
